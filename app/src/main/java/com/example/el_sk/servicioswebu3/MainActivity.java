package com.example.el_sk.servicioswebu3;
        ...
        protected String doInBackground(String... params) {
            ...
            if(params[1]=="1"){    // Consulta de todos los alumnos
                ...
                try {
                  ...
                  //  connection.setRequestProperty("User-Agent", "Chrome/51.0" +
                        //    " (Linux; Android 3.1; es-ES) Ejemplo HTTP");
                ...
                try {
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK) {
                        ...
                        if (resultJSON == "1") {      // hay un alumno que mostrar
                            ...
                            Toast.makeText(MainActivity.this, "Insert correcto", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK) {
                        ...
                        if (resultJSON == "1") {      // hay un alumno que mostrar
                            ...
                            Toast.makeText(MainActivity.this, "Update Correcto", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK) {
                        ...
                        if (resultJSON == "1") {      // hay un alumno que mostrar
                            ...
                            Toast.makeText(MainActivity.this, "Delete Correcto", Toast.LENGTH_SHORT).show();
